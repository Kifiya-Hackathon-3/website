...
Derived from [architecture-and-flows.md](./architecture-and-flows.md) (C4 + sequences) and [features.md](./features.md) (actor capabilities). This is the human-readable companion to `api/openapi.yaml`.
...
| Doc | Purpose |
|-----|---------|
| [architecture-and-flows.md](./architecture-and-flows.md) | C4 views and sequence diagrams |
| [features.md](./features.md) | Actor capabilities and gaps |
| [implementation-plan.md](./implementation-plan.md) | Phased engineering roadmap |
| `api/openapi.yaml` | Authoritative machine-readable contract |
